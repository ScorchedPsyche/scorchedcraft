...
public class PlayerUtil {
    ...
    /**
     * Sends a CHAT or ACTION BAR message to the player.
     * @param player The player to send the message to
     * @param message Message to be sent
     * @param sendOnActionBar TRUE send as Action Bar msg and FALSE as Chat msg
     */
    public static void sendMessage(@Nullable PlayerEntity player, String message, boolean sendOnActionBar)
    {
        if( player != null )
        {
            player.sendMessage( Text.of( message ), sendOnActionBar  );
        }
    }
     ...
     * @param sendOnActionBar TRUE send as Action Bar msg and FALSE as Chat msg
     */
    public static void sendMessage(@Nullable PlayerEntity player, StringFormattedModel message, boolean sendOnActionBar)
    {
        sendMessage(player, message.toString(), sendOnActionBar);
    }
