...
//        this.rgba = new ColorRenderModel(red, green, blue, alpha);
//    }
//    public BlockOutlineModel(BlockPos blockPos, int red, int green, int blue)
//    {
//        this.blockPos = blockPos;
//        this.rgba = new ColorRenderModel(red, green, blue, 1);
//    }
//
//    private final BlockPos blockPos;
//    private final ColorRenderModel rgba;
//
//    public BlockPos getBlockPos() {
//        return blockPos;
//    }
//    public ColorRenderModel getRgba() {
//        return rgba;
//    }
//}
