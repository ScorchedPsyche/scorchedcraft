...
public class SeasonManager {
                                    ...
                                    boolean account, long date_start, long date_end, String version_start, String version_end)
    {
        ...
        if ( DatabaseManager.database.executeSqlAndDisplayErrorIfNeeded(sql) )
        {
            ...
            ConsoleUtil.logError( ScorchedCraftManager.Seasons.Name.full, "Failed to create season.");
        }
    ...
    public SeasonModel fetchActiveSeason()
    {
        String sql = "SELECT * FROM " + DatabaseTables.Seasons.table_name +
            " WHERE status = " + ScorchedCraftManager.Seasons.Status.Active.ordinal() + " LIMIT 1";
